...
def get_activations(ims, model, batch_size=50, dims=2048,
...
def calculate_activation_statistics(ims, model, batch_size=50,
                                    dims=2048, cuda=False, verbose=False):
    """Calculation of the statistics used by the FID.
    Params:
    -- ims       : cuda tensor of images
    -- model       : Instance of inception model
...
def _compute_statistics_of_im(ims, model, batch_size, dims, cuda):
    m, s = calculate_activation_statistics(ims, model, batch_size,
                                           dims, cuda)
    return m, s
...
def calculate_fid_given_ims(ims_1,ims_2, batch_size, cuda, dims=2048):
    ...
    m1, s1 = _compute_statistics_of_im(ims_1, model, batch_size,
                                         dims, cuda)
    m2, s2 = _compute_statistics_of_im(ims_2, model, batch_size,
                                         dims, cuda)
    fid_value = calculate_frechet_distance(m1, s1, m2, s2)

    return fid_value

def calculate_fid_given_acts(acts_1, acts_2):
    """Calculates the FID of two paths"""
